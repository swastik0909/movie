    ...
    <section className="px-6 md:px-16 mt-14 relative group">
      ...
      <button
        ...
        className="absolute left-2 top-1/2 -translate-y-1/2 z-20 
                   bg-black/60 hover:bg-black p-2 rounded-full 
        ...
        {cast.map((person) => (
          ...
          >
            ...
            <div className="w-24 h-24 mx-auto rounded-full overflow-hidden 
                            bg-zinc-800 ring-2 ring-transparent 
                            group-hover/cast:ring-red-600 transition">
              <img
                src={
                  person.profile_path
                ...
                className="w-full h-full object-cover 
                           group-hover/cast:scale-110 transition"
                loading="lazy"
              />
            </div>
